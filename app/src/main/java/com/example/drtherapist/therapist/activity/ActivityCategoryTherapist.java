...
import com.example.drtherapist.therapist.adapter.CategoryAdapterTherapist;
...
public class ActivityCategoryTherapist extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private CategoryAdapterTherapist mAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_category_therapist);
        initView();
        ClickListner();
    }
    ...
    private void initView() {
        ...
        /*mAdapter = new SpecialItemMenuAdapter(specialItemList, this);
        ...
        mAdapter = new CategoryAdapterTherapist(catagoryList, this);
