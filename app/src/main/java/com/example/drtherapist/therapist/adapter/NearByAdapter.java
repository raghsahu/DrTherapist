...
public class NearByAdapter  extends RecyclerView.Adapter<NearByAdapter.ViewHolder> {
    ...
    public NearByAdapter(List<NearByModel> nearByModels, Context context) {
    ...
    public void onBindViewHolder(@NonNull NearByAdapter.ViewHolder holder, final int position) {
        if (nearByModels.size() > 0) {
            nearByModel = nearByModels.get(position);
            holder.tv_title.setText(nearByModel.title);
            holder.tv_address.setText(nearByModel.location);
            holder.tv_distance.setText(nearByModel.distance);
            holder.tv_days.setText(nearByModel.days);
            holder.tv_children.setText(nearByModel.client_count);
            holder.tv_price.setText(nearByModel.doller_rate);

            postDate = nearByModel.date;
            ...
            holder.img_profile.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //To passmodel
                    i.putExtra("jobModel", nearByModel);
            ...
            if (!nearByModel.image.equalsIgnoreCase(null) && !nearByModel.image.equalsIgnoreCase("")) {

                Picasso.with(context).load(nearByModel.image)
